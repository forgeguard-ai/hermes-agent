...
[GitHub Release](https://github.com/forgeguard-ai/hermes-agent/releases). Those macOS builds
...
[Desktop → Troubleshooting](https://github.com/forgeguard-ai/hermes-agent/blob/main/website/docs/user-guide/desktop.md#macos-hermes-is-damaged-and-cant-be-opened)).
