...
export const en: Translations = {
  ...
  connectionMode: {
    ...
    localDesc: 'Advanced: run a private Hermes backend on this machine. Works offline.',
    clientTitle: 'Client Mode',
    clientDesc: 'Connect to an already-running Hermes backend on another machine or server. Recommended.',
    ...
    recentEndpoints: 'Recent endpoints',
    connect: 'Connect',
    ...
    firstRunDescription: 'Connect to an existing Hermes backend, or set up a private Hermes runtime on this machine.',
    firstRunLocalDesc: 'Advanced: install and run a full Hermes backend on this machine. Works offline.',
    firstRunClientDesc: 'Connect to a Hermes backend that is already running elsewhere. Recommended — no local install needed.',
  ...
  settings: {
    ...
    gateway: {
      ...
      localDesc: 'Start a private Hermes backend on localhost. Works offline.',
