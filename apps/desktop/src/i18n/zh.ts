...
export const zh: Translations = {
  ...
  connectionMode: {
    ...
    localTitle: '本地运行时',
    localDesc: '高级：在本机管理并运行 Hermes 后端。可离线使用。',
    clientTitle: '客户端模式',
    clientDesc: '连接到已在运行的远程 Hermes 后端。推荐。',
    currentLocal: '当前：本地运行时',
    currentRemote: url => `当前：${url}`,
    urlTitle: '后端地址',
    urlDesc: '输入 Hermes 仪表盘后端的地址。',
    recentEndpoints: '最近使用的端点',
    connect: '连接',
    useLocal: '使用本地运行时',
    ...
    firstRunDescription: '连接到已在运行的 Hermes 后端，或在本机搭建私有的 Hermes 运行时。',
    firstRunLocalDesc: '高级：在本机安装并运行完整的 Hermes 后端。可离线使用。',
    firstRunClientDesc: '连接到已在其他位置运行的 Hermes 后端。推荐 — 无需本地安装。',
  ...
  settings: {
    ...
    gateway: {
      ...
      localTitle: '本地网关',
      localDesc: '在 localhost 启动私有 Hermes 后端。可离线工作。',
      remoteTitle: '远程网关',
      remoteDesc:
