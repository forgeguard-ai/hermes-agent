...
tts:
  ...
  openai:
    ...
    base_url: "https://api.openai.com/v1"  # Override for OpenAI-compatible TTS endpoints (used by both the whole-file and streaming paths; OPENAI_BASE_URL is never consulted)
    speed: 1.0                  # 0.25 - 4.0
