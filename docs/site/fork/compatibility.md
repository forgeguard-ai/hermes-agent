...
| Fork release line | `v0.20.5` | Latest [fork release](https://github.com/forgeguard-ai/hermes-agent/releases). |
| Hermes product version | `0.20.5` (fork line; upstream `v2026.8.16.2` is product `0.20.3`) | `pyproject.toml` (names the release tag and title). |
